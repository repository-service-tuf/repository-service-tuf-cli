...
class TestCeremony:
    def test_ceremony_offline(
        self, ceremony_inputs, patch_getpass, patch_utcnow
    ):
        """Test case 2 without using the OUTPUT argument."""
        ...
        assert "Saved result to 'ceremony-payload.json'" in result.stdout

    def test_ceremony_offline_with_custom_output(
        self,
        ceremony_inputs,
        client,
        test_context,
        ...
        """Test case 2 using custom OUTPUT argument."""
        input_step1, input_step2, input_step3, input_step4 = ceremony_inputs
    ...
    def test_ceremony_offline_threshold_less_than_2(
        self, ceremony_inputs, patch_getpass, patch_utcnow
    ):
    ...
    def test_ceremony_offline__non_positive_expiration(
        self, ceremony_inputs, patch_getpass, patch_utcnow
    ):
    ...
    def test_ceremony_bootstrap_api_server(
        self,
        ceremony_inputs,
        monkeypatch,
        patch_getpass,
    ...
    def test_ceremony_bootstrap_api_server_with_timeout(
        self,
        ceremony_inputs,
        monkeypatch,
        patch_getpass,
        ...
        input_step1, input_step2, input_step3, input_step4 = ceremony_inputs
        timeout = 450
        args = ["--api-server", "http://localhost:80", "--timeout", timeout]
    ...
    def test_ceremony_bootstrap_api_server_with_output_argument(
        self,
        ceremony_inputs,
        monkeypatch,
        client,
