...
Minimum recommended: 2 Keys and Threshold equal 1.

Example:
Corp Example Inc, will use two keys and a threshold of 1. Keys Owners:
- CTO (Jimi Hendrix)
...
Recommended: 2 Keys and Threshold equal 2. Destroy after the ceremony.

Example:
Corp Example Inc,  will use two keys and threshold of two keys.
...
Recommended: 2 Keys and Threshold equal 2.

Example:
Corp Example Inc,  will use two keys and a threshold of 2 keys.
- Head of Development (Kurt Kobain)
- Release Manager (Chris Cornel).
...
Recommended: 1 Key and Threshold equal 1
